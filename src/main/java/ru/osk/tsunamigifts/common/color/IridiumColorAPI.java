package ru.osk.tsunamigifts.common.color;

import com.google.common.collect.ImmutableMap;
import net.md_5.bungee.api.ChatColor;
import org.apache.commons.lang.Validate;
import org.bukkit.Bukkit;
import ru.osk.tsunamigifts.common.color.patterns.GradientPattern;
import ru.osk.tsunamigifts.common.color.patterns.Pattern;
import ru.osk.tsunamigifts.common.color.patterns.RainbowPattern;
import ru.osk.tsunamigifts.common.color.patterns.SolidPattern;
...
public class IridiumColorAPI {
     ...
     * @since 1.0.2
     */
    private static final List<Pattern> PATTERNS = (List<Pattern>) Arrays.asList(new GradientPattern(), new SolidPattern(), new RainbowPattern());
